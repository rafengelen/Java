...
public class ExerciseDateAnalyzerApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("On that day you were 100 days old: " + dateAnalyzer.get100DaysOld() );
        System.out.println("On that day you were 10 months old: " + dateAnalyzer.get10MonthsOld() );
        System.exit(0);
