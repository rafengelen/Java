...
public class ExerciseTextAnalyzerApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Total number of letters in the text: " + textAnalyzer.countLetters());
        System.out.println("Total number of digits in the text: " + textAnalyzer.countDigits() );
